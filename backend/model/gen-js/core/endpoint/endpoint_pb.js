...
goog.exportSymbol('proto.endpoint.StepType', null, global);
goog.exportSymbol('proto.endpoint.Variable', null, global);
goog.exportSymbol('proto.endpoint.VariableType', null, global);
...
proto.endpoint.Variable.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pb_default: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
proto.endpoint.Variable.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.endpoint.VariableType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
 ...
 * @return {!proto.endpoint.VariableType}
 */
proto.endpoint.Variable.prototype.getType = function() {
  return /** @type {!proto.endpoint.VariableType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.endpoint.VariableType} value
...
proto.endpoint.Step.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.endpoint.StepType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 4:
...
/**
 * optional StepType type = 3;
 * @return {!proto.endpoint.StepType}
 */
proto.endpoint.Step.prototype.getType = function() {
  return /** @type {!proto.endpoint.StepType} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.endpoint.StepType} value
 * @return {!proto.endpoint.Step} returns this
 */
